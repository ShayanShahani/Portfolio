    ...
    switch (mainCommand) {
      ...
      case "skills":
        pushHistory(
          ...
          createLine("• Vue.js / Nuxt.js"),
          createLine("• TypeScript / JavaScript"),
          createLine("• Tailwind CSS / SCSS"),
          createLine("• UI/UX Design"),
          createLine("• Responsive Web Development"),
          createLine("• Vite / Webpack"),
          createLine("• WordPress, Umbraco etc."),
          createLine(""),
          createLine("Backend:", "success"),
          createLine("• Node.js / Express"),
          createLine("• PHP / Laravel / Slim"),
          createLine("• Python / Django"),
          createLine("• Rust & Go learning"),
          createLine("• SQL: MySQL, PostgreSQL"),
          createLine("• NoSQL: MongoDB"),
          createLine("• RESTful APIs / GraphQL"),
          createLine(""),
          createLine("Game Development:", "success"),
          createLine("• Unity / Unreal Engine"),
          createLine("• C# / C++"),
          createLine("• Godot Engine"),
          createLine("• Blender 3D / 3D Modeling"),
          createLine("• Game mechanics and systems"),
          createLine("• Animations for machinery and vehicles"),
          createLine(""),
          createLine("DevOps & Tools:", "success"),
          createLine("• Docker / Containerization"),
          createLine("• CI/CD Pipelines"),
          createLine("• Git / GitHub"),
          createLine("• Agile / Scrum"),
          createLine("• AWS / Cloud Services"),
          createLine("• Linux / Unix"),
          createLine(""),
        );
        break;
