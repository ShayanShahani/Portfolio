...
export default function Terminal({ isDarkMode = true }: TerminalProps) {
  ...
  const executeCommand = (cmd: string) => {
    ...
    setHistory((prev) => [...prev, `shayan@macbook-pro ~ $ ${cmd}`, ""]);
    ...
    switch (mainCommand) {
      ...
      case "contact":
        setHistory((prev) => [
          ...
          "└─────────┘",
          "",
          "Email: my@domainmail.com",
          "GitHub: github.com/ShayanShahani",
          "LinkedIn: linkedin.com/in/mylinkedin/",
          "Website: shayanshahani.dev",
          "",
        ]);
        break;
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        <span className="mr-2">shayan@macbook-pro ~ $</span>
        <input
          ref={inputRef}
          type="text"
          value={input}
